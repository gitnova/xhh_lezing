...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('vSPgEOqLJybmQR3VeudWQRZ3QNap1O0QETo6RPXT5hAqmYbDA4Kj16IS');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a13377d680ad9.85357356')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'vSPgEOqLJybmQR3VeudWQRZ3QNap1O0QETo6RPXT5hAqmYbDA4Kj16IS',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-11-21',
            'locale' => 'en-US',
            'cookie_key' => '9rvCbLMpW6m8azH51ZiYhprH0MAaoA340FCCQMOO994VbH8WvvrvzUXH',
            'cookie_iv' => 'QQGiftxT',
            'new_cookie_key' => 'def00000eabc7e9e780cc20f84ce1c6863a87332224f43b25cbe43c3e1809437aee354c39dd7d2ee2f7fc1c1c330a3b880a089ca8261142f82a0fb28c1e8d0434ecafea9',
            ...
            'kernel.secret' => 'vSPgEOqLJybmQR3VeudWQRZ3QNap1O0QETo6RPXT5hAqmYbDA4Kj16IS',
